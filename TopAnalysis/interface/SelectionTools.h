...
class SelectionTool {
 ...
 public:
  ...
  std::vector<Particle> leptons_,vetoLeptons_,photons_,tmpPhotons, lowPtPhotons;
  ...
  std::vector<Particle> flaggedPhotons(MiniEvent_t &ev, double minPt = 30.);
  ...
  std::vector<Particle> &getLowPtPhotons()  { return lowPtPhotons; }
